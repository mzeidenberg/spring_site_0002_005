...
|M 2/7|   05|One-way selection statements ("if"); boolean operators and boolean expressions; two-way selection statements ("if" ... "else"); nested selection statements; string comparison; multi-way selection statements ("if" ... "elif" ... "else"); logical operators; boolean variables; generating random numbers ("and", "or", "not")|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
...
|M 2/14|   07| Introduction to repetition structures ("loops"); condition-controlled loops (the "while" loop); "infinite loops"; the "break" statement; using an accumulator variable to calculate running totals; augmented assignment operators; using sentinal values to control execution flow; the "break" statement; data validation using a "while" loop|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
...
|W 2/23|   09| Condition-Controlled ("While") Loops Part II; Solving Problems with "while" loops|exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
...
|M 4/4|   18|foo|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
|W 4/6|   19|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
|M 4/11|   20|foo|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
|W 4/13|   21|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
|M 4/18|   22|foo|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
|W 4/20|   23|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
|M 4/25|   24|foo|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
|W 4/27|   25|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
|M 5/2|   26|foo|Self-paced learning module #3 and quiz, exit ticket from previous class|Exit ticket|None|
|W 5/4|   27|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
|M 5/9|   28|Workshop|Assignment #2; exit ticket from previous class|Assignment #3, self-paced learning module #4 and quiz, exit ticket|None|
